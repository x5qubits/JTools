...
namespace JTcpNetwork
{
    public class NetBuffer
    {
        ...
        public byte ReadByte()
        {
            ...
            {
                throw new IndexOutOfRangeException("ReadByte out of range:" + ToString());
            }
        ...
        public void ReadBytes(byte[] buffer, uint count)
        {
            ...
            {
                throw new IndexOutOfRangeException("ReadBytes out of range: (" + count + ") " + ToString());
            }
        ...
        private void WriteCheckForSpace(ushort count)
        {
            ...
            while (Position + count >= newLen)
            {
                ...
                {
                    if (NetConfig.logFilter >= LogFilter.Warning) Log.Warning("Size is " + newLen + " bytes!");
                }
            }
        ...
        {
            return String.Format("sz:{0} pos:{1}", m_Buffer.Length, Position);
        }
    } // end NetBuffer
